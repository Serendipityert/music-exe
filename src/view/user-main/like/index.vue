<template>
    <div class="pl-2">
        <t-tabs :default-value="1" size="medium">
                            ...
                            <div class="text-gray-500 text-left p-2 mt-1 flex flex-row justify-between">
                                <div class="flex flex-row">
                                    <div class="cursor-pointer">
                                        <t-tooltip content="取消喜欢" theme="light">
                                            <svg t="1661996050870" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                                ...
                                                <path d="M485.366 442.861h-49.305V492.183h49.305V443.056z"
                                                    fill="#FFFFFF" opacity=".4" p-id="10253"></path>
                                                <path
                                    ...
                                    <t-dropdown trigger="hover">
                                        <div
                                            class="ml-1 w-48 mr-2 truncate text-xs mt-1 text-gray-500 song cursor-pointer">
                                        ...
                                        <div class="cursor-pointer mt-0.5 mr-1">
                                            <t-tooltip content="更多" theme="light">
                                                <svg t="1662000763788" class="icon" viewBox="0 0 1024 1024"
                                                    version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="56250"
                                                    width="16" height="16">
                                                    <path
            ...
            <t-tab-panel :value="2" label="歌单 ">
                <p style="margin: 20px">歌单</p>
            </t-tab-panel>
            <t-tab-panel :value="3" label="专辑 ">
                <p style="margin: 20px">专辑</p>
            </t-tab-panel>
            <t-tab-panel :value="4" label="视频">
                <p style="margin: 20px">视频</p>
            </t-tab-panel>
        </t-tabs>
    </div>
</template>
