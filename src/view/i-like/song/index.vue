            ...
            <div class="flex flex-row">
              <div class="cursor-pointer">
                <t-tooltip content="取消喜欢" theme="light">
                  ...
                  >
                    ...
                    ></path>
                    <path
                      d="M485.366 442.861h-49.305V492.183h49.305V443.056z"
                      fill="#FFFFFF"
                      opacity=".4"
                      p-id="10253"
                    ></path>
              ...
              <t-dropdown trigger="hover">
                <div class="ml-1 w-64 mr-2 flex flex-row">
                  <div
                    class="truncate text-xs mt-1 text-gray-500 song cursor-pointer"
                  >
                  ...
                  <div class="w-80 h-24 text-xs rounded-lg">
                    ...
                    <div class="mt-1 p-2 justify-around">
                      <span class="w-64 mr-2">
                        大小: {{ item.tone1 }}M / {{ item.tone2 }}M /
                        {{ item.tone3 }}M / {{ item.tone4 }}M
                      </span>
...
const song_list = ref<any[]>([
  ...
  },
  {
    ...
    quality: 4,
    album: "你若三冬",
    url: "https://qti.oss-cn-shenzhen.aliyuncs.com/music/%E9%98%BF%E6%82%A0%E6%82%A0%20-%20%E4%BD%A0%E8%8B%A5%E4%B8%89%E5%86%AC.mp3",
    img: "https://p3fx.kgimg.com/stdmusic/240/20200304/20200304105908439743.jpg",
  },
]);
