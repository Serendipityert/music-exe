    ...
    <div class="flex flex-col">
        <div class="flex flex-col">
            <div class="flex flex-wrap content-start ml-2">
                <div class="w-20 h-10 cursor-pointer mr-4 p-2" v-if="area" v-for="( item, index ) in area" :key="index"
            ...
            <div class="flex flex-wrap content-start mt-2 ml-1">
                <div class="w-20 h-10 cursor-pointer mr-4 p-4" v-if="type" v-for="( item, index ) in type" :key="index"
        ...
        <div class="mt-4 flex flex-col">
            <div class="flex flex-wrap content-start mt-4 ml-3">
                <div class=" cursor-pointer mr-1 hover:text-blue-700" v-if="alphabet"
                    v-for="( item, index ) in alphabet" :key="index" @click="search.alphabet = item">
...
getSongerList(search.value.type, search.value.area, search.value.alphabet, 30).then((res: any) => {
    if (res.code === 200) {
