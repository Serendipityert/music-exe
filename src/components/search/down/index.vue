        ...
        <div class="flex flex-col mt-1">
            <div class="flex flex-row">
                ...
                <div class="flex h-full flex-col ml-2">
                    <div class="w-64 p-2 hover:bg-gray-100  text-sm cursor-pointer" v-for="(item,index) in searchResult.songs" :key="index">
            ...
            <div class="flex flex-row">
                ...
                <div class="flex h-full flex-row ml-2 ">
                    <div class="hover:bg-gray-100 p-2 w-64 flex flex-row" v-for="(item,index) in searchResult.artists" :key="index">
                        <div class="w-10 h-10 ">
            ...
            <div class="flex flex-row">
                ...
                <div class="flex h-full flex-col ml-2 ">
                    <div class="hover:bg-gray-100 p-2 w-64 flex flex-row" v-for="(item,index) in searchResult.albums" :key="index">
                        <div class="w-10 h-10 ">
