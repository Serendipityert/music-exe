 ...
 * @returns
 */
export const sendPhoneVerifyCode = async <T extends Record<string, any>>(
  data: T | undefined
) => {
  /**
   * @resType 返回台参数类型
 ...
 * @returns
 */
export const verifyPhoneCode = async <T extends Record<string, any>>(
  data: T | undefined
) => {
  /**
   * @resType 返回台参数类型
 ...
 * @returns
 */
export const userPhoneCreate = async <T extends Record<string, any>>(
  data: T | undefined
) => {
  return await Axios<resType>({
    url: "/create",
 ...
 * @returns
 */
export const userPhoneLogin = async <T extends Record<string, any>>(
  data: T | undefined
) => {
  return await Axios<resType>({
    url: "/login",
...
export const generateQRCode = async (
  qrimg: number | undefined,
  data: string | undefined
) => {
  return await Axios({
    url: "/login/qr/create?qrimg=" + qrimg + "&key=" + data,
    method: "get",
  }).catch((err: any) => {
    MessagePlugin.warning(err);
  });
 ...
 * @returns
 */
export const queryQRCodeState = async (
  data: string | undefined,
 ...
 * @returns
 */
export const getUserCollectionMvQuantity = async (
 ...
 * @returns
 */
export const getPrivateMsgDetail = async (
...
export const sendMsg = async (
  ...
  return await Axios({
    url: "/send/text?user_ids=" + uid + "&cookie=" + cookie + "&msg=" + msg,
    method: "get",
  }).catch((err: any) => {
    MessagePlugin.warning(err);
  });
