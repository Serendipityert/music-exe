 ...
 * @returns
 */
export const getDayRecommendSongs = async (
  cookie: string | undefined | any
) => {
  return await Axios({
 ...
 * @returns
 */
export const getDayRecommendPlayList = async (
  cookie: string | undefined | any
) => {
  return await Axios({
...
export const getDayRecommendDj = async (cookie: string | undefined | any) => {
  return await Axios({
    url: "/dj/recommend?cookie=" + cookie,
    method: "get",
  }).catch((err: any) => {
    MessagePlugin.warning(err);
  });
...
export const getHotSongerList = async (num: number | undefined) => {
  return await Axios({
    url: "/top/artists?offset=0&limit=" + num,
    method: "get",
  }).catch((err: any) => {
    MessagePlugin.warning(err);
  });
 ...
 * @returns
 */
export const getSongerList = async (
 ...
 * @returns
 */
export const getPayRadioClassification = async (
  limit: number | undefined,
  offset: number | undefined
) => {
  return await Axios({
    url: "/dj/paygift?limit=" + limit + "&offset=" + offset,
    method: "get",
  }).catch((err: any) => {
    MessagePlugin.warning(err);
  });
 ...
 * @returns
 */
export const getRadioPersonalizedRecommend = async (
  limit: number | undefined
) => {
  return await Axios({
...
export const geAlbumSongSaleBoard = async (albumSongSaleBoardSearch: any) => {
  return await Axios({
    url:
      ...
      albumSongSaleBoardSearch.value.type +
      "&year=" +
      albumSongSaleBoardSearch.value.year +
      "&albumType=" +
      albumSongSaleBoardSearch.value.albumType +
      "&limit=" +
      albumSongSaleBoardSearch.value.limit +
      "&offset=" +
      albumSongSaleBoardSearch.value.offset,
    method: "get",
  }).catch((err: any) => {
    MessagePlugin.warning(err);
  });
 ...
 * @returns
 */
export const buyNumberAlbum = async (
  id: any,
  payment: number,
  quantity: number,
  cookie: string
...
export const myNumberAlbum = async (limit: number, cookie: string) => {
  return await Axios({
    url: "/digitalAlbum/purchased?cookie=" + cookie + "&limit=" + limit,
    method: "get",
  }).catch((err: any) => {
    MessagePlugin.warning(err);
  });
