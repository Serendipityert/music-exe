      ...
      <div class="w-80 h-14">
        <div class="flex flex-row">
          <div class="w-10 h-10 mt-2 rounded-md cursor-pointer">
            <img @click="openBottomDrawer" style="width: 100%; height: 100%; border-radius: 6px"
              :src="currMusic.currSong.al.picUrl" />
          </div>
          <t-drawer :cancelBtn="cancelBtn" :closeBtn="closeBtn" :mode="mode" :header="header" :footer="footer"
            :confirmBtn="confirmBtn" v-model:visible="visibleBottom" :size="size"
            :on-click-overlay="() => (visibleBottom = false)" :placement="placementBottom"
            @click-cancel="visibleBottom = false" @onClose="onCloseDrawer">
            <MusicDrawer />
          </t-drawer>
          <div class="w-52 h-14 ml-4">
            <div class="music-name flex flex-row justify-start mt-1">
              ...
              <router-link to="/play-mv">
                <div class="mt-1 ml-2 cursor-pointer">
                  <t-tooltip class="placement bottom center" theme="primary" content="MV" placement="bottom" show-arrow>
                    <svg t="1661405040731" class="icon" viewBox="0 0 1024 1024" version="1.1"
                      xmlns="http://www.w3.org/2000/svg" p-id="17866" width="18" height="18">
                      <path
            ...
            <div class="mt-1 flex flex-row justify-start">
              <div class="mr-4 cursor-pointer">
                <t-tooltip class="placement bottom center" theme="primary" content="我喜欢" placement="bottom" show-arrow>
                  <svg t="1661405629879" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="20222" width="20" height="20">
                    <path
              ...
              <t-dropdown trigger="click" placement="top">
                <div class="mr-4 cursor-pointer">
                  <t-tooltip class="placement bottom center" theme="primary" content="下载" placement="bottom" show-arrow>
                    <svg t="1661406146914" class="icon" viewBox="0 0 1024 1024" version="1.1"
                      xmlns="http://www.w3.org/2000/svg" p-id="13058" width="18" height="18">
                      <path
                ...
                <template #dropdown>
                  <t-dropdown-item class="pt-1" :value="0">
                    <div class="flex flex-row">
                      ...
                      <div>
                        <svg t="1661414010246" class="icon" viewBox="0 0 1024 1024" version="1.1"
                          xmlns="http://www.w3.org/2000/svg" p-id="51572" width="20" height="20">
                          <path d="M383.95 447.78h255.88L511.89 831.6z" fill="#F47DC4" p-id="51573"></path>
                          <path
                            d="M639.82 447.79L511.89 831.58 383.96 447.79h255.86m0.01-0.01H383.95l127.94 383.83 127.94-383.83z"
                            fill="#FCE6F4" p-id="51574"></path>
                          <path d="M224.02 447.78h159.01l128.85 383.8z" fill="#D86AAB" p-id="51575"></path>
                          <path
                            d="M383.02 447.79l128.84 383.77-287.83-383.77h158.99m0.01-0.01H224.01l287.88 383.83-128.86-383.83z"
                            fill="#FCE6F4" p-id="51576"></path>
                          <path d="M639.84 447.78h159.92L511.9 831.59z" fill="#CE4E91" p-id="51577"></path>
                          <path
                            d="M799.74 447.79L511.92 831.56l127.92-383.77h159.9m0.02-0.01H639.83L511.89 831.61l287.87-383.83z"
                            fill="#FCE6F4" p-id="51578"></path>
                          <path d="M319.97 255.86l63.98 191.92H224.01z" fill="#E254A2" p-id="51579"></path>
                          <path d="M511.89 255.86l127.94 191.92H383.95z" fill="#F998D7" p-id="51580"></path>
                          <path d="M703.81 255.86l95.95 191.92H639.83z" fill="#DB4DA1" p-id="51581"></path>
                          <path d="M319.98 255.86l191.91 0.01-127.94 191.9z" fill="#F76DCD" p-id="51582"></path>
                          <path
                            d="M511.87 255.87L383.95 447.76l-63.96-191.88h191.88m0.02-0.02z m0 0H319.97l63.97 191.92 127.95-191.92z"
                            fill="#FCE6F4" p-id="51583"></path>
                          <path d="M511.89 255.86l191.92 0.01-63.98 191.9z" fill="#EF6ABF" p-id="51584"></path>
                          <path
                            d="M703.79 255.87l-63.96 191.88-127.92-191.88h191.88m0.02-0.01z m0 0H511.89l127.94 191.92 63.98-191.92z"
                            fill="#FCE6F4" p-id="51585"></path>
                        </svg>
                      </div>
                      <div class="mt-0.5">
                        <svg t="1661414185714" class="icon" viewBox="0 0 1024 1024" version="1.1"
                          xmlns="http://www.w3.org/2000/svg" p-id="61201" width="14" height="14">
                          <path
              ...
              <t-dropdown trigger="click" placement="top">
                <div class="mr-4 cursor-pointer">
                  <t-tooltip class="placement bottom center" theme="primary" content="更多" placement="bottom" show-arrow>
                    <svg t="1661405958607" class="icon" viewBox="0 0 1024 1024" version="1.1"
                      xmlns="http://www.w3.org/2000/svg" p-id="2467" width="18" height="18">
                      <path
                ...
                <template #dropdown>
                  <t-dropdown-item class="pt-1" :value="0">
                    <div class="flex flex-row">
                      <div>
                        <svg t="1661416497111" class="icon" viewBox="0 0 1024 1024" version="1.1"
                          xmlns="http://www.w3.org/2000/svg" p-id="63989" width="18" height="18">
                          <path
                  ...
                  <t-dropdown-item :value="3">
                    <t-dropdown trigger="hover" placement="right-bottom">
                      <div class="flex flex-row">
                        <div>
                          <svg t="1661416626456" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="66057" width="18" height="18">
                            <path
                        ...
                        <div class="text-xs text-gray-800 ml-10">
                          <svg t="1661417372396" class="icon" viewBox="0 0 1024 1024" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" p-id="17905" width="12" height="12">
                            <path d="M798.38 538.03l-575.1-346.2 0.04-68.75 575.04 345.6 0.02 69.35z" p-id="17906">
                            </path>
                            <path d="M798.38 538.03L223.3 894.99v-69.52l575.06-356.79 0.02 69.35z" p-id="17907"></path>
                          </svg>
                        </div>
                      </div>
                      <template #dropdown>
                  ...
                  <t-dropdown-item :value="4">
                    <div class="flex flex-row">
                      <div>
                        <svg t="1661416815794" class="icon" viewBox="0 0 1024 1024" version="1.1"
                          xmlns="http://www.w3.org/2000/svg" p-id="67686" width="18" height="18">
                          <path
                  ...
                  <t-dropdown-item :value="5">
                    <div class="flex flex-row">
                      <div>
                        <svg t="1661417073245" class="icon" viewBox="0 0 1024 1024" version="1.1"
                          xmlns="http://www.w3.org/2000/svg" p-id="8350" width="18" height="18">
                          <path
                  ...
                  <t-dropdown-item :value="6">
                    <div class="flex flex-row">
                      <div>
                        <svg t="1661417106545" class="icon" viewBox="0 0 1127 1024" version="1.1"
                          xmlns="http://www.w3.org/2000/svg" p-id="9382" width="18" height="18">
                          <path
                  ...
                  <t-dropdown-item class="-mb-4" :value="7">
                    <div class="flex flex-row">
                      <div>
                        <svg t="1661417154600" class="icon" viewBox="0 0 1024 1024" version="1.1"
                          xmlns="http://www.w3.org/2000/svg" p-id="12408" width="18" height="18">
                          <path
                  ...
                  <t-dropdown-item class="-mt-3 pb-1" :value="8">
                    <div class="flex flex-row">
                      <div>
                        <svg t="1661417236389" class="icon" viewBox="0 0 1024 1024" version="1.1"
                          xmlns="http://www.w3.org/2000/svg" p-id="17497" width="18" height="18">
                          <path
              ...
              <router-link to="/music-comment">
                <div class="mr-4 cursor-pointer">
                  <t-tooltip class="placement bottom center" theme="primary" content="评论" placement="bottom" show-arrow>
                    <svg t="1661406034042" class="icon" viewBox="0 0 1024 1024" version="1.1"
                      xmlns="http://www.w3.org/2000/svg" p-id="8267" width="18" height="18">
                      <path
      ...
      <div class="w-64 h-14">
        <div class="flex flex-row justify-center h-12 mt-1">
          ...
          <t-dropdown trigger="click" placement="top">
            <div class="mt-4 mr-2 cursor-pointer">
              <div v-show="playMode === 3">
                <t-tooltip class="placement bottom center" theme="primary" content="单曲循环" placement="bottom" show-arrow>
                  <svg t="1661406889223" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="13534" width="20" height="20">
                    <path
              ...
              <div v-show="playMode === 1">
                <t-tooltip class="placement bottom center" theme="primary" content="随机播放" placement="bottom" show-arrow>
                  <svg t="1661410857030" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="33643" width="18" height="18">
                    <path
              ...
              <div v-show="playMode === 2">
                <t-tooltip class="placement bottom center" theme="primary" content="顺序播放" placement="bottom" show-arrow>
                  <svg t="1661411358908" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="35330" width="18" height="18">
                    <path
            ...
            <template #dropdown>
              ...
              <t-dropdown-item :value="2" @click="playMode = 3">
                <div class="flex flex-row">
                  <div>
                    <svg t="1661411423469" class="icon" viewBox="0 0 1024 1024" version="1.1"
                      xmlns="http://www.w3.org/2000/svg" p-id="35914" width="20" height="20">
                      <path
                        d="M361.5 727.8c-119.1 0-215.9-96.9-215.9-215.9 0-119.1 96.9-215.9 215.9-215.9 2.3 0 4.6-0.2 6.8-0.6v58.3c0 12.3 14 19.4 23.9 12.1l132.6-97.6c8.1-6 8.1-18.2 0-24.2l-132.6-97.6c-9.9-7.3-23.9-0.2-23.9 12.1v58.1c-2.2-0.4-4.5-0.6-6.8-0.6-39.8 0-78.5 7.9-115 23.4-35.2 15-66.8 36.3-94 63.5s-48.6 58.8-63.5 94c-15.5 36.5-23.4 75.2-23.4 115s7.9 78.5 23.4 115c15 35.2 36.3 66.8 63.5 94s58.8 48.6 94 63.5c36.5 15.5 75.2 23.4 115 23.4 22.1 0 40-17.9 40-40s-17.9-40-40-40zM938.2 396.9c-15-35.2-36.3-66.8-63.5-94s-58.8-48.6-94-63.5c-36.5-15.5-75.2-23.4-115-23.4-22.1 0-40 17.9-40 40s17.9 40 40 40c119.1 0 215.9 96.9 215.9 215.9 0 119.1-96.9 215.9-215.9 215.9-4.1 0-8.1 0.6-11.8 1.8v-60.8c0-12.3-14-19.4-23.9-12.1l-132.6 97.6c-8.1 6-8.1 18.2 0 24.2L629.9 876c9.9 7.3 23.9 0.2 23.9-12.1V806c3.7 1.2 7.7 1.8 11.8 1.8 39.8 0 78.5-7.9 115-23.4 35.2-15 66.8-36.3 94-63.5s48.6-58.8 63.5-94c15.5-36.5 23.4-75.2 23.4-115s-7.8-78.5-23.3-115z"
                        p-id="35915"></path>
                      <path
          ...
          <div @click="prevSong" class="mt-3.5 mr-2 cursor-pointer">
            <t-tooltip class="placement bottom center" theme="primary" content="上一首" placement="bottom" show-arrow>
              <svg t="1661407367422" class="icon" viewBox="0 0 1024 1024" version="1.1"
                xmlns="http://www.w3.org/2000/svg" p-id="14142" width="24" height="24">
                <path d="M362.3 512l445-332.3v664.5L362.3 512zM216.7 179.7h80v664.5h-80V179.7z" fill="" p-id="14143">
                </path>
              </svg>
            </t-tooltip>
          </div>
          ...
          <div class="mt-2 mr-2 cursor-pointer" @click="handlePauseOrPlay">
            <t-tooltip class="placement bottom center" theme="primary" content="播放" placement="bottom" show-arrow>
              <!-- 播放 -->
              <svg v-show="!isPlay" t="1662022208359" class="icon" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  fill="#0052d9" p-id="3755"></path>
              </svg>
            </t-tooltip>
            <!-- 暂停 -->
            <t-tooltip class="placement bottom center" theme="primary" content="暂停" placement="bottom" show-arrow>
              <svg v-show="isPlay" t="1662022353274" class="icon" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path
                  ...
                  p-id="10349" fill="#0052d9"></path>
              </svg>
            </t-tooltip>
          </div>
          <!-- 下一首 -->
          <div @click="nextSong" class="mt-3.5 mr-2 cursor-pointer">
            <t-tooltip class="placement bottom center" theme="primary" content="下一首" placement="bottom" show-arrow>
              <svg t="1661407402865" class="icon" viewBox="0 0 1024 1024" version="1.1"
                ...
                <path d="M216.7 844.3V179.7l445 332.3-445 332.3z m590.6 0h-80V179.7h80v664.6z" fill="" p-id="14657">
                </path>
              </svg>
            </t-tooltip>
          </div>
          ...
          <t-dropdown trigger="click" placement="top">
            <div class="mt-4 cursor-pointer">
              <t-tooltip class="placement bottom center" theme="primary" content="音量" placement="bottom" show-arrow>
                <svg t="1661407824607" class="icon" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="23825" width="20" height="20">
                  <path
            ...
            <template #dropdown>
              <div class="h-60 w-14 flex flex-col">
                <div class="pt-4 h-48">
                  <t-slider v-model="currVolume" :onChange="handVolume" :max="volumeMax" :min="volumeMin"
                    :step="volumeStep" :layout="vertical" :show-tooltip="true" />
                </div>
                <div class="mt-2 pt-1 h-8 flex justify-center font-bold">
                  {{ currVolume }}%
                </div>
                <div class="mt-1 h-12 flex justify-center mb-1 pt-2 cursor-pointer">
                  <svg t="1661412977821" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="40226" width="20" height="20">
                    <path
      ...
      <div class="w-64 h-14">
        <div class="flex flex-row justify-end mr-4 h-8 mt-3">
          ...
          <div class="mt-1 ml-1 mr-1 music-word cursor-pointer text-gray-800">
            <t-tooltip class="placement bottom center" theme="primary" content="打开歌词" placement="bottom" show-arrow>
              词
            </t-tooltip>
          </div>
          <div class="mt-1 flex flex-row cursor-pointer" @click="handleClick">
            <t-tooltip class="placement bottom center" theme="primary" content="播放队列" placement="bottom" show-arrow>
              <div class="flex flex-row cursor-pointer">
                <svg t="1661408695693" class="icon" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="33082" width="24" height="24">
                  <path
          ...
          <div>
            <t-drawer v-model:visible="visible" :show-overlay="false" header="播放队列" :on-confirm="handleClose"
              @close="handleClose">
              <div>
                <t-row v-for="(item, i) in musicList" :key="i" class="h-12 hover:bg-gray-50 hover:text-gray-800"
                  ...
                  <t-col span="12" class="">
                    <div class="text-gray-500 text-left p-2 mt-1 flex flex-row">
                      <div class="flex flex-row text-gray-200">
                        <div class="ml-1 w-28 mr-2 truncate text-xs mt-1 text-gray-300 song cursor-pointer">
                          {{ item.name }}
                        </div>
                        <!-- 音质 -->
                        <div class="flex flex-row mt-0.5">
                          <div class="mt-1 w-7 h-3 border rounded-sm border-purple-400">
                            <span class="text-purple-600" style="
                                font-size: 7px;
                                font-weight: 900;
                                position: relative;
                                top: -8px;
                          ...
                          <div class="mt-1 w-4 h-3 border rounded-sm border-yellow-400">
                            <span class="text-yellow-600" style="
                                font-size: 7px;
                                font-weight: 900;
                                position: relative;
                                top: -8px;
                          ...
                          <div class="mt-1 w-4 h-3 border rounded-sm border-green-400">
                            <span class="text-green-600" style="
                                font-size: 7px;
                                font-weight: 900;
                                position: relative;
                                top: -8px;
                      ...
                      <div class="flex flex-row mt-0.5 ml-1" :style="mouseStyle === i ? '' : 'display: none;'">
                        <div @click="player(item, i)" :style="isPlayShow === i ? 'display: none;' : ''"
                          ...
                          <t-tooltip content="播放" theme="light">
                            <svg t="1661999623333" class="icon" viewBox="0 0 1024 1024" version="1.1"
                              ...
                              <path d="M511.4 511.9m-426.3 0a426.3 426.3 0 1 0 852.6 0 426.3 426.3 0 1 0-852.6 0Z"
                        ...
                        <div @click="suspend(item)" :style="isPlayShow === i ? '' : 'display: none;'"
                          class="cursor-pointer mt-0.5 mr-1">
                        ...
                        <t-dropdown trigger="click" placement="right-top">
                          ...
                          <template #dropdown>
                              ...
                              <t-dropdown trigger="hover" placement="right-bottom">
                                <div class="flex flex-row">
                                  ...
                                  <div class="text-xs text-gray-800 ml-10">
                                    <svg t="1661417372396" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                      xmlns="http://www.w3.org/2000/svg" p-id="17905" width="12" height="12">
                                      <path d="M798.38 538.03l-575.1-346.2 0.04-68.75 575.04 345.6 0.02 69.35z"
                                        p-id="17906"></path>
                                      <path d="M798.38 538.03L223.3 894.99v-69.52l575.06-356.79 0.02 69.35z"
                                        p-id="17907"></path>
                                    </svg>
                                  </div>
                                </div>
                            ...
                            <t-dropdown-item class="-mt-3 pb-1" :value="8">
                              <div class="flex flex-row">
                                <div>
                                  <svg t="1662515831033" class="icon" viewBox="0 0 1024 1024" version="1.1"
