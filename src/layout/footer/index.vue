<template>
    <div class="m-footer w-screen" :style="m_footer_width">
        <div class="mt-1">
                    ...
                    <div class="w-52 h-14 ml-4">
                        <div class="music-name flex flex-row justify-start mt-1">
                            ...
                            <router-link to="/play-mv">
                                <div class="mt-1 ml-2 cursor-pointer">
                                    <t-tooltip class="placement bottom center" theme="primary" content="MV"
                        ...
                        <div class="mt-1 flex flex-row justify-start">
                            <div class="mr-4 cursor-pointer">
                                <t-tooltip class="placement bottom center" theme="primary" content="我喜欢"
                                    placement="bottom" show-arrow>
                            ...
                            <t-dropdown trigger="click" placement="top">
                                <div class="mr-4 cursor-pointer">
                                    <t-tooltip class="placement bottom center" theme="primary" content="下载"
                                        placement="bottom" show-arrow>
                                ...
                                <template #dropdown>
                                    <t-dropdown-item class="pt-1" :value="0">
                                        <div class="flex flex-row">
                                            ...
                                            <div>
                                                <svg t="1661414010246" class="icon" viewBox="0 0 1024 1024"
                                                    version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="51572"
                                                    width="20" height="20">
                                                    <path d="M383.95 447.78h255.88L511.89 831.6z" fill="#F47DC4"
                                                        p-id="51573"></path>
                                                    <path
                                                    ...
                                                    <path d="M224.02 447.78h159.01l128.85 383.8z" fill="#D86AAB"
                                                        p-id="51575"></path>
                                                    <path
                                                    ...
                                                    <path d="M639.84 447.78h159.92L511.9 831.59z" fill="#CE4E91"
                                                        p-id="51577"></path>
                                                    <path
                                                    ...
                                                    <path d="M319.97 255.86l63.98 191.92H224.01z" fill="#E254A2"
                                                        p-id="51579"></path>
                                                    <path d="M511.89 255.86l127.94 191.92H383.95z" fill="#F998D7"
                                                        p-id="51580"></path>
                                                    <path d="M703.81 255.86l95.95 191.92H639.83z" fill="#DB4DA1"
                                                        p-id="51581"></path>
                                                    <path d="M319.98 255.86l191.91 0.01-127.94 191.9z" fill="#F76DCD"
                                                        p-id="51582"></path>
                                                    <path
                                                    ...
                                                    <path d="M511.89 255.86l191.92 0.01-63.98 191.9z" fill="#EF6ABF"
                                                        p-id="51584"></path>
                                                    <path
                                            ...
                                            <div class="mt-0.5">
                                                <svg t="1661414185714" class="icon" viewBox="0 0 1024 1024"
                                                    version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="61201"
                                                    width="14" height="14">
                                                    <path
                                    ...
                                    <t-dropdown-item :value="2">
                                        <div class="flex flex-row">
                                            <div class="text-xs text-gray-800 ml-1 mt-0.5">SQ无损品质</div>
                                            <div>
                                                <svg t="1661414010246" class="icon" viewBox="0 0 1024 1024"
                                                    version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="51572"
                                                    width="20" height="20">
                                    ...
                                    <t-dropdown-item class="pb-1" :value="3">
                                        <div class="flex flex-row">
                                            <div class="text-xs text-gray-800 ml-1 mt-0.5">Hi-Res品质</div>
                                            <div>
                                                <svg t="1661414010246" class="icon" viewBox="0 0 1024 1024"
                                                    version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="51572"
                                                    width="20" height="20">
                            ...
                            <t-dropdown trigger="click" placement="top">
                                <div class="mr-4 cursor-pointer">
                                    <t-tooltip class="placement bottom center" theme="primary" content="更多"
                                        placement="bottom" show-arrow>
                            ...
                            <router-link to="/music-comment">
                                <div class="mr-4 cursor-pointer">
                                    <t-tooltip class="placement bottom center" theme="primary" content="评论"
                                        placement="bottom" show-arrow>
                ...
                <div class="flex flex-row justify-center h-12 mt-1">
                    ...
                    <t-dropdown trigger="click" placement="top">
                        <div class="mt-4 mr-2 cursor-pointer">
                            <t-tooltip class="placement bottom center" theme="primary" content="单曲循环" placement="bottom"
                                show-arrow>
                        ...
                        <template #dropdown>
                            ...
                            <t-dropdown-item class="pb-1" :value="3">
                                <div class="flex flex-row">
                                    <div>
                                        <svg t="1661411460101" class="icon" viewBox="0 0 1024 1024" version="1.1"
                                            xmlns="http://www.w3.org/2000/svg" p-id="36255" width="20" height="20">
                                            <path
                                                d="M361.5 727.8c-119.1 0-215.9-96.9-215.9-215.9 0-119.1 96.9-215.9 215.9-215.9 2.3 0 4.6-0.2 6.8-0.6v58.3c0 12.3 14 19.4 23.9 12.1l132.6-97.6c8.1-6 8.1-18.2 0-24.2l-132.6-97.6c-9.9-7.3-23.9-0.2-23.9 12.1v58.1c-2.2-0.4-4.5-0.6-6.8-0.6-39.8 0-78.5 7.9-115 23.4-35.2 15-66.8 36.3-94 63.5s-48.6 58.8-63.5 94c-15.5 36.5-23.4 75.2-23.4 115s7.9 78.5 23.4 115c15 35.2 36.3 66.8 63.5 94s58.8 48.6 94 63.5c36.5 15.5 75.2 23.4 115 23.4 22.1 0 40-17.9 40-40s-17.9-40-40-40zM938.2 396.9c-15-35.2-36.3-66.8-63.5-94s-58.8-48.6-94-63.5c-36.5-15.5-75.2-23.4-115-23.4-22.1 0-40 17.9-40 40s17.9 40 40 40c119.1 0 215.9 96.9 215.9 215.9 0 119.1-96.9 215.9-215.9 215.9-4.1 0-8.1 0.6-11.8 1.8v-60.8c0-12.3-14-19.4-23.9-12.1l-132.6 97.6c-8.1 6-8.1 18.2 0 24.2L629.9 876c9.9 7.3 23.9 0.2 23.9-12.1V806c3.7 1.2 7.7 1.8 11.8 1.8 39.8 0 78.5-7.9 115-23.4 35.2-15 66.8-36.3 94-63.5s48.6-58.8 63.5-94c15.5-36.5 23.4-75.2 23.4-115s-7.8-78.5-23.3-115z"
                                                p-id="36256"></path>
                                        </svg>
                    ...
                    <t-dropdown trigger="click" placement="top">
                        <div class="mt-4 cursor-pointer">
                            <t-tooltip class="placement bottom center" theme="primary" content="音量" placement="bottom"
                                show-arrow>
                        ...
                        <template #dropdown>
                            <div class="h-60 w-14 flex flex-col">
                                <div class="pt-4 h-48">
                                    <t-slider v-model="currVolume" :onChange="handVolume" :max="volumeMax"
                                        :min="volumeMin" :step="volumeStep" :layout="vertical" :show-tooltip="true" />
                                </div>
                                <div class="mt-2 pt-1 h-8 flex justify-center font-bold">{{ currVolume }}%</div>
            ...
            <div class="w-64 h-14 ">
                <div class="flex flex-row justify-end mr-4 h-8 mt-3">
                    ...
                    <div class="mt-1 ml-1 mr-1 music-word cursor-pointer text-gray-800">
                        <t-tooltip class="placement bottom center" theme="primary" content="打开歌词" placement="bottom"
                            show-arrow>
                            词
                        </t-tooltip>
                    </div>
                    <div class="mt-1 flex flex-row cursor-pointer" @click="handleClick">
                        <t-tooltip class="placement bottom center" theme="primary" content="播放队列" placement="bottom"
                            show-arrow>
                            <div class="flex flex-row cursor-pointer">
