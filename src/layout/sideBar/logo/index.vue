<template>
    <div class="l-logo flex flex-row">
        <div>
            <svg t="1661262537591" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="28877" width="32" height="32">
                <path
                ...
                <path
                    ...
                    fill="#F7F9F4" p-id="28881"></path>
            </svg>
        </div>
        <div class="title"><span>初识音乐</span></div>
    </div>
</template>
