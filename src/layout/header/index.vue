                  ...
                  <template #prefix-icon>
                    <svg
                      ...
                      <path
                        ...
                        p-id="52744"></path>
                      <path
                        d="M669.184 731.52l45.248-45.226667 186.154667 186.133334-45.248 45.248z"
                        fill="#5C1CF7"
                        p-id="52745"></path>
                    </svg>
                  </template>
                  ...
                  <t-tooltip
                    ...
                    <svg
                      ...
                      <path
                        ...
                        p-id="9665"></path>
                      <path
                        d="M404.7 372.6m-139.3 0a139.3 139.3 0 1 0 278.6 0 139.3 139.3 0 1 0-278.6 0Z"
                        fill="#1afa29"
                        p-id="9666"></path>
                      <path
                ...
                <t-dropdown trigger="hover">
                  <div>
                    <svg
                      ...
                      height="26">
                      <path
                        d="M516.4 433.9m-85 0a85 85 0 1 0 170 0 85 85 0 1 0-170 0Z"
                        fill="#1E88E5"
                        p-id="42997"></path>
                      <path
...
// 搜索歌曲
const searchMusic = () => {
  searchMusicProposal(search_name.value)
    .then((res: any) => {
      if (res.code === 200) {
